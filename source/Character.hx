...
class Character extends FlxSprite
{
	...
	public var playercolorR:Int = 0;
	public var playercolorG:Int = 0;
	public var playercolorB:Int = 0;
	public var playercolorA:Int = 255;
	// Player color in RGBA Format due to Flixel "fromstring" being broken on my version of flixel
	// Sorry about that
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf-opt':
				...
				playercolorB = 209;
				playercolorA = 255;
				var tex = Paths.getSparrowAtlas('BOYFRIEND-opt');
				frames = tex;
