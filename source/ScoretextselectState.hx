	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.LEFT)
			...
			if (FlxG.keys.justPressed.DOWN && scoretextlayout > 0 && scoretextlayout <= 10)
				...
				if (scoretextlayout == 0)
					scoretextlayouttext = 'Expanded';
				if (scoretextlayout == 1)
					scoretextlayouttext = 'Compact';
				if (scoretextlayout == 2)
					scoretextlayouttext = 'Kade Engine 1.4.2';
				if (scoretextlayout == 3)
					scoretextlayouttext = 'Kade Engine 1.0';
				if (scoretextlayout == 4)
					scoretextlayouttext = 'Beta';
				if (scoretextlayout == 5)
					scoretextlayouttext = 'Alpha';
				if (scoretextlayout == 6)
					scoretextlayouttext = 'Psyche Engine';
				if (scoretextlayout == 7)
					scoretextlayouttext = 'Base (Centered)';
				if (scoretextlayout == 8)
		...
		if (FlxG.keys.justPressed.ESCAPE)
			{
				...
				if (scoretextlayout == 0)
					{
					    FlxG.save.data.Scoretext = "swiftenginescoretext";
					}
				if (scoretextlayout == 1)
					{
					    FlxG.save.data.Scoretext = "swiftenginecompact";
					}	
				if (scoretextlayout == 2)
					{
						FlxG.save.data.Scoretext = "kadeengine142scoretext";
					}
				if (scoretextlayout == 3)
					{
						FlxG.save.data.Scoretext = "kadeengine10scoretext";
					}
				if (scoretextlayout == 4)
					{
						FlxG.save.data.Scoretext = "unknownenginescoretext";
					}
				if (scoretextlayout == 5)
					{
						FlxG.save.data.Scoretext = "sniperenginealphascoretext";
					}
				if (scoretextlayout == 6)
					{
						FlxG.save.data.Scoretext = "pscyheenginescoretext";
					}
				if (scoretextlayout == 7)
					{
						FlxG.save.data.Scoretext = "basefnfscoretext";
					}
				if (scoretextlayout == 8)
					{
						FlxG.save.data.Scoretext = "kadeengine18scoretext";
					}
				if (scoretextlayout == 9)
					{
						FlxG.save.data.Scoretext = "fpsplusenginescoretext";
					}
				if (scoretextlayout == 10)
					{
						FlxG.save.data.Scoretext = "noscoretext";
					}	
			}
